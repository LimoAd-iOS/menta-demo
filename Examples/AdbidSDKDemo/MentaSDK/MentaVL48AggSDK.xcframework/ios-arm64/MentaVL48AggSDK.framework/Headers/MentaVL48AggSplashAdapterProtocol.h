...
/// 开屏广告适配层代理（回调给MentaVL48AggSplashAd）
@protocol MentaVL48AggSplashAdapterDelegate <NSObject>
@optional
/// 素材加载成功 extra 扩展数据
...
/// 开屏广告适配层抽象协议
@protocol MentaVL48AggSplashAdapterProtocol <NSObject>

/// 适配层代理（回调至MentaVL48AggSplashAd）
